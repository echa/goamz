...
func (s *S) TestInitMulti(c *check.C) {
	...
	options := s3.Options{
		...
		RedirectLocation: "http://github.com/echa/goamz",
	...
	c.Assert(req.Header["X-Amz-Website-Redirect-Location"], check.DeepEquals, []string{"http://github.com/echa/goamz"})
